...
1. `/guides/food-allergy-survival-guide.html` — targets "how to eat safely in Thailand with food allergies"
2. `/guides/hidden-allergens-thai-food.html` — targets "Thai food hidden allergens"  
3. `/recommendations/best-esims-thailand.html` — affiliate page, targets "best eSIM Thailand"
4. `/thailand-essentials/emergency-healthcare.html` — targets "medical emergency Thailand"
